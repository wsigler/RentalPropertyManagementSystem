...
namespace RPMS_BusinessLogic
{
    public class PDFConverter
    {
        ...
        public string ConvertToPDF(string host, string dir, string filePath, string urlPage)
        {
            ...
            int count = 1;
            string tempFileName = dir + filePath;
            ...
            {
                count++;
                tempFileName = string.Format("{0}{1}({2})", dir, filePath, count);
            }
