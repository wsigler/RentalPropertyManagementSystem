                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <asp:RadioButton Checked="true" runat="server" ID="rbNonRenewal" GroupName="gnDocuments" CssClass="radio radio-inline" Text="Non Renewal"/>
                                <asp:RadioButton runat="server" ID="rbNoticeOfEntry" GroupName="gnDocuments" CssClass="radio radio-inline" Text="Notice of Entry"/>
                            </div>
                        </div>
                        <br />
                        <div class="row">
